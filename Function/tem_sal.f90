...
!$omp end parallel do
    ...
    call syncborder_real8(flux_x, nz)
    call syncborder_real8(flux_zx, nz+1)
    call syncborder_real8(coef_zx, nz+1)
    call syncborder_real8(sfgm_zx, nz+1)

    call syncborder_real8(flux_y, nz)
    call syncborder_real8(flux_zy, nz+1)
    call syncborder_real8(coef_zy, nz+1)
    call syncborder_real8(sfgm_zy, nz+1)
